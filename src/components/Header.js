...
const Header = () => {
    ...
    return (
        <NavBar>
            ...
            <NavButton selected={selectedButton === 1} label={"Trending"} onClick={() => handleClick(1,"/trending")} />
            <NavButton selected={selectedButton === 2} label={"Popular"} onClick={() => handleClick(2,"/popular/1")} />
            <NavButton selected={selectedButton === 3} label={"Discover"} onClick={() => {handleClick(3)}}/>
            <NavButton selected={selectedButton === 4} label={"Top Rated"} onClick={() => handleClick(4,"/topRated/1")}/>
            {/* <NavSearchBar /> */}
        </NavBar>
    );
}
