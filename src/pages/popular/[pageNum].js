    ...
    <>
      {movieList.length === 0 ? 
        ...
        <>
          ...
          <ButtonRibbon>
            <Button onClick={() => router.push("/popular/"+Math.max(1,pageNum-1))} label="Prev"/>
            {
            ...
            <Button onClick={() => router.push("/popular/"+Math.min(1000,pageNum+1))} label="Next"/>
          </ButtonRibbon>
        </>
      }
    </>
